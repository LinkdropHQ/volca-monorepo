...
const TokensLinkdropContractService = require("../lib/services/TokensLinkdropContractService");
...
const abi = require("../lib/contracts/TokensLinkdrop").abi;
...
const contractAddress = config.get("ERC20_LINKDROP_CONTRACT_ADDRESS");
...
(async () => {
  ...
  TokensLinkdropContractService.checkClaimParams(claimParams);
